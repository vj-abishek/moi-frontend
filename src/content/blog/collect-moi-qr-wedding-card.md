...
Here’s how to set that up in Moi and get a QR code you can print on your card.
...
## 2. Add at least one recipient (name + UPI ID)

Contributions are tied to recipients. Add the person (or account) that will receive the UPI payments.
...
## 3. Get the contribution link (and copy it if you need it)
...
## 4. Open the event and get the QR code
...
## Tips for using the QR on the card

- **Print size:** Make the QR code large enough to scan easily—usually at least 2–3 cm on the card. Test by scanning a printout before bulk printing.
- **Contrast:** Keep the QR area clear (no patterns or text over the code) and ensure good contrast (e.g. dark on light) so phones can read it reliably.
- **Test the link:** Before finalising the design, open the link from your phone and do a small test payment if you can. Confirm the correct UPI ID receives the money and the contribution shows in Moi.
- **Same link everywhere:** Use the same contribution link (and thus the same QR) on the card, in messages, and on any digital invite. One link keeps tracking simple and consistent.

If you’ve already set up UPI for your function and just need a clean way to get the link onto the card and track who gave what, this flow—create event → add recipients → copy link → download QR and put it on the card—is all you need.
